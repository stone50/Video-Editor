...
if __name__ == "__main__":
    ...
    parser.add_argument("fileName", type=str, help="name of the video file including the file extension")
    parser.add_argument("--threshold", "-t", type=float, default=1, choices=range(0, 1), help="similarity threshold (1 = cut only exact duplicates, 0 = cut all frames)")
